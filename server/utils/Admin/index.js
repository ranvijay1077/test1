...
const adminUtils = {
                ...
                try {
                    ...
                    await transporter.sendMail({
                        ...
                        html: "<b>Greetings, </b><br /><br />Here is your 4 Digits verification Code<br />" +
                            ...
                            "</small></label><br /><br /><label>Thanks & Regards</label><br /><label>FICE " +
                            "</label>", // html body
                    });
    ...
    getAllDropDown: async(data) => {
        let result = await getDataArray(Dropdown, { type:data.type, status:{$ne:2}}, '',null, {created_at:-1});
        if (result.status) {
    ...
    addDropdown: async(data) => {
        let {type , name} = data;
         let d = {
          ...
          let obj = new Dropdown(d);
          let result = await postData(obj);
         if (result.status) {
